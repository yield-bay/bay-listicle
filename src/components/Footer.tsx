...
export default function Footer() {
  ...
  return (
    <footer className="border-t dark:border-neutral-800 dark:bg-neutral-800 dark:bg-opacity-60" aria-labelledby="footer-heading">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div className="xl:grid xl:grid-cols-2 xl:gap-8">
          ...
          <div className="space-y-3 xl:col-span-1">
            ...
            <div className="text-neutral-500 dark:text-neutral-100 text-base">
              <p>
                Yield Farming hub for all dotsama farms.
              </p>
              <p className="mt-1">
            ...
            <div className="flex space-x-6">
              <a href="#" className="text-neutral-400 hover:text-neutral-500 dark:hover:text-neutral-200">
          ...
          <div className="md:grid md:grid-cols-2 md:gap-8">
            <div className="mt-12 xl:mt-0">
              ...
              <ul role="list" className="mt-4 space-y-4 text-base">
                {ecosystem.map((ele) => (
                  <List title={ele.title} link={ele.link} />
                ))}
              </ul>
            </div>
            <div className="mt-12 xl:mt-0">
        ...
        <div className="mt-12 border-t border-neutral-200 dark:border-neutral-700 pt-8">
          <p className="text-base text-neutral-400 dark:text-neutral-200 xl:text-center">
            ...
            <a
              className="text-primary-400 dark:text-primary-300 hover:text-primary-400 dark:hover:text-primary-200 underline"
...
const List = ({ title, link }: { title: string; link: string }): any => {
  return (
    <li>
      <a href={link} className="inline-flex text-neutral-500 dark:text-white font-medium hover:text-neutral-900 dark:hover:text-neutral-300">
        {title}
